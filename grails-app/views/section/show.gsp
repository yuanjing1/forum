	...
	<body>
		...
		<div id="show-section" class="content scaffold-show" role="main">
			...
			<ol class="property-list section">
				...
				<g:if test="${sectionInstance?.title}">
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="section.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${sectionInstance}" field="title"/></span>
